...
#define BTN_PWR 18  // GPIO 18 – short: toggle web portal / long: settings menu

// ── WiFi Manager AP ──────────────────────────────────────────────────────────
#define WIFI_AP_NAME     "TuerDisplay-Setup"
#define WIFI_AP_PASSWORD ""                    // open AP (no password)
#define WIFI_TIMEOUT_S   120                   // seconds WiFiManager portal stays open
#define WIFI_CONNECT_TIMEOUT_MS 60000UL        // 60s auto-reconnect on boot
#define WIFI_LONG_PRESS_MS      500            // BTN_PWR hold time for settings menu
